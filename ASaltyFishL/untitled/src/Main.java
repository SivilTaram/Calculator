...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SaveToFile(question, ret, "exercise.txt");
    }
    ...
    public static void SaveToFile(String question, String answer, String filename) throws IOException {
        FileWriter writer = new FileWriter(filename, true);
        writer.write(question + " " + answer + System.lineSeparator());
        writer.close();
    }
}
